    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center bg-card shadow-sm">
        <Link href="#" className="flex items-center justify-center">
          ...
          <span className="ml-2 text-xl font-headline font-semibold">Clarity Hub</span>
        </Link>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Welcome to Clarity Hub. The all-in-one productivity suite with tasks, notes, whiteboards, and mind maps. Powered by AI to keep you on track.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  From simple to-do lists to complex project planning, Clarity Hub has you covered.
                </p>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2024 Clarity Hub. All rights reserved.</p>

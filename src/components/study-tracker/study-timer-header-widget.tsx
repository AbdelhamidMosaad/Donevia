...
export function StudyTimerHeaderWidget() {
    const { activeSubtopic, elapsedTime, stopTimer, isActive } = useStudyTimer();

    if (!isActive || !activeSubtopic) {
        return null;
    }
    ...
    return (
        <div className="flex items-center gap-2 bg-blue-100 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-800 p-1.5 rounded-lg">
            ...
            <div className="flex flex-col">
                <span className="text-xs font-semibold text-blue-800 dark:text-blue-200 truncate max-w-28">{activeSubtopic.title}</span>

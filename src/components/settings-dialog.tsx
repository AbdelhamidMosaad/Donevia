...
const themes: { name: Theme; label: string; icon: React.ReactNode; colors: { bg: string; text: string; primary: string; secondary: string } }[] = [
  ...
  { name: 'theme-indigo', label: 'Indigo', icon: <Palette className="h-5 w-5" />, colors: { bg: '#6D28D9', text: 'hsl(230 80% 98%)', primary: 'hsl(234 65% 26%)', secondary: 'hsl(232 46% 28%)' } },
  { name: 'theme-purple', label: 'Purple', icon: <Palette className="h-5 w-5" />, colors: { bg: '#6D28D9', text: 'hsl(280 80% 98%)', primary: 'hsl(279 65% 40%)', secondary: 'hsl(279 40% 27%)' } },

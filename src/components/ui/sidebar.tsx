...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex h-14 items-center gap-2 p-4 group-data-[collapsible=icon]:h-auto group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:py-4 [&>span]:group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <ScrollArea
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col group-data-[collapsible=icon]:items-center",
        className
      )}
    >
